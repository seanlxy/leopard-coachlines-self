            ...
            foreach ($rows as $index => $row)
            {
                ...
                <tr>
                    ...
                    <td style="padding-left:{$indentation}px;">
                        ...
                        <input type="text" name="testm_rank[]" value="$rank" style="display:none;color:#999999;margin-right:10px;margin-left:10px;width:30px;text-align:center;">
                        $editlink
                    </td>
