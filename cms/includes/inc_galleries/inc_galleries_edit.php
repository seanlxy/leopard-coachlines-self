    ...
    if( !empty($photos) )
    {
        ...
        foreach ($photos as $photocount => $photo)
        {
            ...
            <li id="photo_{$photocount}" class="img-thumbnail">
                ...
                <input type="text" placeholder="Caption" value="{$caption}" name="caption[]" style="width:270px;">
                <input type="text" placeholder="Name" value="{$name}" name="name[]" style="display:none; width:160px;">
                
                <input type="text" placeholder="Alt text" value="{$alt_text}" name="alt_text[]" style="width:270px;">
...
var newSlide = '<li id="photo-'+num+'" class="img-thumbnail">\
            ...
            <input style="width: 270px;" type="text" placeholder="Caption" value="" name="caption[]">\
            <input style="width: 270px;" type="text" placeholder="Alt text" value="" name="alt_text[]">\
            <input style="width: 270px;" type="hidden" value="" name="photo-thumb-path[]">\
            <input style="width: 270px;" type="hidden" value="'+newPhotoUrl+'" name="photo-full-path[]">\
       </li>';
