    ...
    function generate_item_list($parent_id = 0)
    {
        ...
        if( !empty($rows) )
        {
            ...
            foreach ($rows as $index => $row)
            {
                ...
                if ($show_on_home_page == "Y") { $show_on_homepage_status = '<span class="label label-success">Yes</span>'; }
                if ($show_on_home_page == "N") { $show_on_homepage_status = '<span class="label label-warning">No</span>'; }
                ...
                <tr>
                    ...
                    <td width="60">$show_on_homepage_status</td>
                </tr>
HTML;
            }
        ...
        <table width="100%" class="bordered">
            <thead>
                <tr>
                    ...
                    <th  width="170" align="left">Show On Home Page</th>
                </tr>
            </thead>
            <tbody>
                $active_pages
