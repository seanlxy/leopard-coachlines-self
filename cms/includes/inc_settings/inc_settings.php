...
HTML;
    ...
    $companydetails_content = <<< HTML
        <table width="100%" border="0" cellspacing="0" cellpadding="4">
            ...
            <tr>
                <td width="150"><label for="youtube_id">Homepage Video ID <br>(youtube)</label></td>
                <td><input name="youtube_id" id="youtube_id" type="text" value="{$youtube_id}" style="width:350px;" /></td>
            </tr>
            <tr>
                <td width="150" valign="top"><label for="email_address">Email(s)</label> <span data-title="Separate multiple email addresses with a semicolon ( ; )" data-placement="right" data-toggle="tooltip"></span></td>
...
function save_item()
{
    ...
    $temp_array_save['youtube_id']                 = filter_input(INPUT_POST, 'youtube_id');
