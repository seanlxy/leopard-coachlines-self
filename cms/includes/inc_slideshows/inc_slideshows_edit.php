    ...
    if( !empty($photos) )
    {
        ...
        foreach ($photos as $photocount => $photo)
        {
            ...
            <li id="photo_{$photocount}" class="img-thumbnail" style="width:280px;">
                ...
                <input type="text" placeholder="Slide caption" value="{$caption}" name="caption[]" style="width:270px;">
...
var newSlide = '<li id="photo-'+num+'" class="img-thumbnail">\
            ...
            <input type="text" placeholder="Slide caption" value="" name="caption[]" style="width:270px;">\
            <input type="text" placeholder="Alt text" value="" name="alt_text[]" style="width:270px;">\
